...
JNIEXPORT jbyteArray JNICALL Java_org_pngquant_intEn(JNIEnv *env, jclass obj, jintArray src, jlong attr, jint w, jint h, jfloat jfloyd, jint color, jboolean noswap)
{
